...
public class UrnValidationTest {
  ...
  public void testMissingUrnThrowsException() {
    ...
    IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> SimpleExtension.load("some/uri", yamlWithoutUrn));
  ...
  public void testInvalidUrnFormatThrowsException() {
    ...
    IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> SimpleExtension.load("some/uri", yamlWithInvalidUrn));
