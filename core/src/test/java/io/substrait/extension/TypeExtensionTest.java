 ...
 * <ul>
 *     <li>Be read from extension files</li>
 *     <li>Be referenced by functions in extension files</li>
 *     <li>Roundtrip between POJO and Proto</li>
 * </ul>
 */
public class TypeExtensionTest {
  ...
  void roundtripCustomType() {
    ...
    List<String> columnNames = Stream.of("custom_type_column", "i64_column").collect(Collectors.toList());
