...
public class ExpressionProtoConverter
    implements ExpressionVisitor<Expression, Void, RuntimeException> {
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.NullLiteral expr, Void context) {
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.BoolLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setBoolean(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.I8Literal expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setI8(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.I16Literal expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setI16(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.I32Literal expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setI32(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.I64Literal expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setI64(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.FP32Literal expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setFp32(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.FP64Literal expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setFp64(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.StrLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setString(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.BinaryLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setBinary(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.TimeLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setTime(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.DateLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setDate(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.TimestampLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setTimestamp(expr.value()));
  }

  @Override
  public Expression visit(
      io.substrait.expression.Expression.TimestampTZLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setTimestampTz(expr.value()));
  }

  @Override
  public Expression visit(
      io.substrait.expression.Expression.PrecisionTimestampLiteral expr, Void context) {
    return lit(
        bldr ->
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.PrecisionTimestampTZLiteral expr, Void context) {
    return lit(
        bldr ->
            bldr.setNullable(expr.nullable())
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.IntervalYearLiteral expr, Void context) {
    return lit(
        bldr ->
            bldr.setNullable(expr.nullable())
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.IntervalDayLiteral expr, Void context) {
    return lit(
        bldr ->
            bldr.setNullable(expr.nullable())
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.IntervalCompoundLiteral expr, Void context) {
    return lit(
        bldr ->
            bldr.setNullable(expr.nullable())
                .setIntervalCompound(
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.UUIDLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setUuid(expr.toBytes()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.FixedCharLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setFixedChar(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.VarCharLiteral expr, Void context) {
    return lit(
        bldr ->
            bldr.setNullable(expr.nullable())
                .setVarChar(
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.FixedBinaryLiteral expr, Void context) {
    return lit(bldr -> bldr.setNullable(expr.nullable()).setFixedBinary(expr.value()));
  }

  @Override
  public Expression visit(io.substrait.expression.Expression.DecimalLiteral expr, Void context) {
    return lit(
        bldr ->
            bldr.setNullable(expr.nullable())
                .setDecimal(
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.MapLiteral expr, Void context) {
    return lit(
        bldr -> {
          var keyValues =
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.EmptyMapLiteral expr, Void context) {
    return lit(
        bldr -> {
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.ListLiteral expr, Void context) {
    return lit(
        bldr -> {
          var values =
              expr.values().stream()
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.EmptyListLiteral expr, Void context)
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.StructLiteral expr, Void context) {
    return lit(
        bldr -> {
          var values =
              expr.fields().stream()
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.UserDefinedLiteral expr, Void context) {
    var typeReference =
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.Switch expr, Void context) {
    var clauses =
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.IfThen expr, Void context) {
    var clauses =
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.ScalarFunctionInvocation expr, Void context) {
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.Cast expr, Void context) {
    return Expression.newBuilder()
        .setCast(
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.SingleOrList expr, Void context)
      throws RuntimeException {
    return Expression.newBuilder()
        .setSingularOrList(
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.MultiOrList expr, Void context)
      throws RuntimeException {
    return Expression.newBuilder()
        .setMultiOrList(
  ...
  @Override
  public Expression visit(FieldReference expr, Void context) {
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.SetPredicate expr, Void context)
      throws RuntimeException {
    return Expression.newBuilder()
        .setSubquery(
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.ScalarSubquery expr, Void context)
      throws RuntimeException {
    return Expression.newBuilder()
        .setSubquery(
            Expression.Subquery.newBuilder()
  ...
  @Override
  public Expression visit(io.substrait.expression.Expression.InPredicate expr, Void context)
      throws RuntimeException {
    return Expression.newBuilder()
        .setSubquery(
            Expression.Subquery.newBuilder()
  ...
  @Override
  public Expression visit(
      io.substrait.expression.Expression.WindowFunctionInvocation expr, Void context)
      throws RuntimeException {
    var argVisitor = FunctionArg.toProto(typeProtoConverter, this);
