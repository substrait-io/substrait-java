...
public class RelCopyOnWriteVisitor<EXCEPTION extends Exception>
  ...
  protected Optional<Expression.WindowRelFunctionInvocation> visitWindowRelFunction(
      Expression.WindowRelFunctionInvocation windowRelFunctionInvocation) throws EXCEPTION {
    return Optional.of(
