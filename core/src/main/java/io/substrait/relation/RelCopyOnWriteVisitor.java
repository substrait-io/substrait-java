...
public class RelCopyOnWriteVisitor<E extends Exception>
  ...
  public Optional<Rel> visit(final Aggregate aggregate, final EmptyVisitationContext context)
      throws E {
    final Optional<Rel> input = aggregate.getInput().accept(this, context);
    final Optional<List<Aggregate.Grouping>> groupings =
        transformList(aggregate.getGroupings(), context, this::visitGrouping);
    final Optional<List<Aggregate.Measure>> measures =
  ...
  protected Optional<Aggregate.Measure> visitMeasure(
    ...
    final Optional<Expression> preMeasureFilter =
        visitOptionalExpression(measure.getPreMeasureFilter(), context);
    final Optional<AggregateFunctionInvocation> afi =
  ...
  protected Optional<AggregateFunctionInvocation> visitAggregateFunction(
    ...
    final Optional<List<FunctionArg>> arguments = visitFunctionArguments(afi.arguments(), context);
  ...
  public Optional<Rel> visit(final Filter filter, final EmptyVisitationContext context) throws E {
    final Optional<Rel> input = filter.getInput().accept(this, context);
  ...
  public Optional<Rel> visit(final Join join, final EmptyVisitationContext context) throws E {
    final Optional<Rel> left = join.getLeft().accept(this, context);
    final Optional<Rel> right = join.getRight().accept(this, context);
    final Optional<Expression> condition = visitOptionalExpression(join.getCondition(), context);
    final Optional<Expression> postFilter =
        visitOptionalExpression(join.getPostJoinFilter(), context);
  ...
  public Optional<Rel> visit(final NamedScan namedScan, final EmptyVisitationContext context)
      throws E {
    final Optional<Expression> filter = visitOptionalExpression(namedScan.getFilter(), context);
  ...
  public Optional<Rel> visit(final LocalFiles localFiles, final EmptyVisitationContext context)
      throws E {
    final Optional<Expression> filter = visitOptionalExpression(localFiles.getFilter(), context);
  ...
  public Optional<Rel> visit(final Project project, final EmptyVisitationContext context) throws E {
    final Optional<Rel> input = project.getInput().accept(this, context);
    final Optional<List<Expression>> expressions = visitExprList(project.getExpressions(), context);
  ...
  public Optional<Rel> visit(final NamedWrite write, final EmptyVisitationContext context)
    ...
    final Optional<Rel> input = write.getInput().accept(this, context);
  ...
  protected Optional<NamedUpdate.TransformExpression> visitTransformExpression(
      final NamedUpdate.TransformExpression transform, final EmptyVisitationContext context)
      throws E {
    return transform
        .getTransformation()
  ...
  public Optional<Rel> visit(final NamedUpdate update, final EmptyVisitationContext context)
    ...
    final Optional<List<AbstractUpdate.TransformExpression>> transformations =
  ...
  @Override
  public Optional<Rel> visit(final ScatterExchange exchange, final EmptyVisitationContext context)
      throws E {
    final Optional<Rel> input = exchange.getInput().accept(this, context);
    final Optional<List<FieldReference>> fields =
  ...
  public Optional<Rel> visit(
      final SingleBucketExchange exchange, final EmptyVisitationContext context) throws E {
    final Optional<Rel> input = exchange.getInput().accept(this, context);
  ...
  @Override
  public Optional<Rel> visit(
      final MultiBucketExchange exchange, final EmptyVisitationContext context) throws E {
    final Optional<Rel> input = exchange.getInput().accept(this, context);
    final Optional<Expression> expression =
        exchange.getExpression().accept(getExpressionCopyOnWriteVisitor(), context);
  ...
  @Override
  public Optional<Rel> visit(
      final RoundRobinExchange exchange, final EmptyVisitationContext context) throws E {
    final Optional<Rel> input = exchange.getInput().accept(this, context);
    if (allEmpty(input)) {
      return Optional.empty();
    }
  ...
  @Override
  public Optional<Rel> visit(final BroadcastExchange exchange, final EmptyVisitationContext context)
      throws E {
    final Optional<Rel> input = exchange.getInput().accept(this, context);
    if (allEmpty(input)) {
      return Optional.empty();
  ...
  public Optional<Rel> visit(final Sort sort, final EmptyVisitationContext context) throws E {
    final Optional<Rel> input = sort.getInput().accept(this, context);
    final Optional<List<Expression.SortField>> sortFields =
  ...
  public Optional<Rel> visit(final Cross cross, final EmptyVisitationContext context) throws E {
    final Optional<Rel> left = cross.getLeft().accept(this, context);
    final Optional<Rel> right = cross.getRight().accept(this, context);
  ...
  public Optional<Rel> visit(
    ...
    final Optional<Expression> filter =
  ...
  public Optional<Rel> visit(final HashJoin hashJoin, final EmptyVisitationContext context)
      throws E {
    final Optional<Rel> left = hashJoin.getLeft().accept(this, context);
    final Optional<Rel> right = hashJoin.getRight().accept(this, context);
    final Optional<List<FieldReference>> leftKeys =
        transformList(hashJoin.getLeftKeys(), context, this::visitFieldReference);
    final Optional<List<FieldReference>> rightKeys =
  ...
  public Optional<Rel> visit(final MergeJoin mergeJoin, final EmptyVisitationContext context)
      throws E {
    final Optional<Rel> left = mergeJoin.getLeft().accept(this, context);
    final Optional<Rel> right = mergeJoin.getRight().accept(this, context);
    final Optional<List<FieldReference>> leftKeys =
  ...
  public Optional<Rel> visit(
    ...
    final Optional<Rel> left = nestedLoopJoin.getLeft().accept(this, context);
    final Optional<Rel> right = nestedLoopJoin.getRight().accept(this, context);
    final Optional<Expression> condition =
  ...
  public Optional<Rel> visit(
      ...
      throws E {
    final Optional<List<ConsistentPartitionWindow.WindowRelFunctionInvocation>> windowFunctions =
        transformList(
            consistentPartitionWindow.getWindowFunctions(), context, this::visitWindowRelFunction);
    final Optional<List<Expression>> partitionExpressions =
        transformList(
            consistentPartitionWindow.getPartitionExpressions(),
            context,
            (t, c) -> t.accept(getExpressionCopyOnWriteVisitor(), c));
    final Optional<List<Expression.SortField>> sorts =
  ...
  protected Optional<ConsistentPartitionWindow.WindowRelFunctionInvocation> visitWindowRelFunction(
      ...
      final EmptyVisitationContext context)
      throws E {
    final Optional<List<FunctionArg>> functionArgs =
