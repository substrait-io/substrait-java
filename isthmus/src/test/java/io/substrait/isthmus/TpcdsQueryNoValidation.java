...
public class TpcdsQueryNoValidation extends PlanTestBase {
  ...
  @ValueSource(
      ints = {
        ...
        33, 34, 35, 37, 38, 40, 41, 42, 43, 45, 46, 48, 50, 52, 54, 55, 56, 58, 59, 60, 61, 62,
        64, 65, 68, 69, 71, 73, 74, 75, 76, 77, 79, 81, 82, 83, 85, 87, 88, 90, 92, 93, 94, 95,
        96, 97, 99
      })
  ...
  @ValueSource(
      ints = {
        2, 5, 9, 12, 17, 20, 24, 27, 36, 39, 44, 47, 49, 51, 53, 57, 63, 66, 67, 70, 72, 78, 80,
        84, 86, 89, 91, 98
      })
