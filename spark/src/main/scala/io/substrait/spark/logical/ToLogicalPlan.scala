...
class ToLogicalPlan(spark: SparkSession = SparkSession.builder().getOrCreate())
  ...
  override def visit(aggregate: relation.Aggregate, context: Void): LogicalPlan = {
  ...
  override def visit(window: relation.ConsistentPartitionWindow, context: Void): LogicalPlan = {
  ...
  override def visit(join: relation.Join, context: Void): LogicalPlan = {
  ...
  override def visit(join: relation.Cross, context: Void): LogicalPlan = {
    val left = join.getLeft.accept(this, context)
    val right = join.getRight.accept(this, context)
    withChild(left, right) {
  ...
  override def visit(fetch: relation.Fetch, context: Void): LogicalPlan = {
  ...
  override def visit(sort: relation.Sort, context: Void): LogicalPlan = {
  ...
  override def visit(project: relation.Project, context: Void): LogicalPlan = {
  ...
  override def visit(expand: relation.Expand, context: Void): LogicalPlan = {
  ...
  override def visit(filter: relation.Filter, context: Void): LogicalPlan = {
  ...
  override def visit(set: relation.Set, context: Void): LogicalPlan = {
  ...
  override def visit(emptyScan: relation.EmptyScan, context: Void): LogicalPlan = {
    LocalRelation(ToSparkType.toAttributeSeq(emptyScan.getInitialSchema))
  }

  override def visit(virtualTableScan: relation.VirtualTableScan, context: Void): LogicalPlan = {
  ...
  override def visit(namedScan: relation.NamedScan, context: Void): LogicalPlan = {
  ...
  override def visit(localFiles: LocalFiles, context: Void): LogicalPlan = {
